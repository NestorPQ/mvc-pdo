...
<body>
  ...
  <script>
    $(document).ready(function (){
      ...
      //  Variables de ambito genereal(accessibles)
      ...
      $("#tabla-cursos tbody").on("click", ".editar", function(){
        ...
        $.ajax({
          ...
          success: function(result){
            ...
            //  Retornamos lo valores a los controles de FORM
            ...
            //  Ponemos al modal en la pantalla
